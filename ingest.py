...
def create_vector_database():
    ...
    loader = DirectoryLoader(
        r"""C:\Users\lokesh.kadi\Desktop\OnPrem Intilligent search\llama2-chat-with-documents\data""", loader_cls=UnstructuredFileLoader, show_progress=True, use_multithreading=True)
